...
**CCP-4.0 complete (2026-06-06):** [`channel-connect-db-only-rehearsal-plan.md`](channel-connect-db-only-rehearsal-plan.md). **CCP-4.1** complete — **PASS WITH NOTES**. **CCP-4.2** decision: [`channel-connect-db-only-rollout-decision.md`](channel-connect-db-only-rollout-decision.md) — next candidate **CCP-4.3**.
