...
export default function SlaPolicyPage() {
  ...
  const isAdmin = Boolean(meContext && meContext.role === "ADMIN");
    ...
    <main className="sla-policy-root" data-testid="sla-policy-page">
      <aside className="dashboard-app-rail" data-testid="dashboard-app-rail" aria-label="Application">
        ...
        <nav className="app-rail-nav" aria-label="Workspace">
          ...
          {isAdmin ? (
            <a href="/dashboard/channel-settings" className="app-rail-nav-item" data-testid="nav-channel-settings" title="Channel Settings">
              <span className="app-rail-nav-icon" aria-hidden="true">
                CH
              </span>
        ...
        <div className="app-rail-footer">
          <button
            ...
            data-testid="sla-policy-sign-out"
            title="Sign out"
            onClick={() => {
